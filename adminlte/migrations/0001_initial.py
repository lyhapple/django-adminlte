    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_name', models.CharField(max_length=200, null=True, verbose_name='\u6240\u5c5eApp', blank=True)),
                ('model_name', models.CharField(help_text='\u6ce8\u610f\u5927\u5c0f\u5199', max_length=200, null=True, verbose_name='\u6240\u5c5eModel', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(null=True, verbose_name='\u6570\u636e\u5220\u9664\u65f6\u95f4', blank=True)),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='\u6570\u636e\u66f4\u65b0\u65f6\u95f4', null=True)),
                ('name', models.CharField(max_length=255, verbose_name='\u914d\u7f6e\u540d\u79f0(\u82f1\u6587)')),
        ...
        migrations.AddField(
            model_name='permission',
            name='group',
            field=models.ForeignKey(verbose_name='\u89d2\u8272', to='adminlte.LteGroup'),
        ),
        migrations.AddField(
            model_name='permission',
            name='menu',
            field=models.ForeignKey(verbose_name='\u83dc\u5355', blank=True, to='adminlte.Menu', null=True),
        ),
        migrations.AddField(
            model_name='permission',
            name='resource',
            field=models.ForeignKey(verbose_name='\u8d44\u6e90', blank=True, to='adminlte.Resource', null=True),
        ),
        migrations.AddField(
            model_name='menu',
            name='creator',
